				    ...
				    <form action="index.php?exam-master-exams-modify" method="post" class="form-horizontal">
					    ...
					    <div class="form-group">
					        <label class="control-label col-sm-2">题量配比模式：</label>
				          	<div class="col-sm-9">
								<label class="radio-inline">
					          		<input type="radio" autocomplete="off" class="input-text" name="args[examsetting][scalemodel]" value="1" onchange="javascript:changemode($(this).val())"{x2;if:$exam['examsetting']['scalemodel']} checked{x2;endif}/> 开启
					          	</label>
					          	<label class="radio-inline">
					          		<input type="radio" autocomplete="off" class="input-text" name="args[examsetting][scalemodel]" value="0" onchange="javascript:changemode($(this).val())"{x2;if:!$exam['examsetting']['scalemodel']} checked{x2;endif}/> 关闭
					          	</label>
					       </div>
					    </div>
					...
					<div id="sptype" class="hide">
						...
						<div class="form-group questpanel panel_{x2;v:questype['questid']}">
							...
							<div class="col-sm-9 form-inline">
								...
								<a class="btn btn-primary ajax" target="tablecontent" href="index.php?exam-master-exams-ajax-getsubjectknows&questype={x2;v:questype['questid']}&subjectid={x2;$exam['examsubject']}" onclick="javascript:currentP = 'examscale_{x2;v:questype['questid']}';$('#tablecontent').find(':checkbox').attr('checked',false);$('#modal').modal();">配题</a>
...
changemode({x2;$exam['examsetting']['scalemodel']});
</script>
{x2;include:footer}
</body>
</html>
