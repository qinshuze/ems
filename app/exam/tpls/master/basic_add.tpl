...
{x2;endif}
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">
						添加考场
						<a class="btn btn-primary pull-right" href="index.php?exam-master-basic">考试与练习</a>
					</h4>
					<form action="index.php?exam-master-basic-add" method="post" class="form-horizontal">
						...
						<div class="form-group">
							<label for="basicsubjectid" class="control-label col-sm-2">考试题库</label>
							<div class="col-sm-4">
								<select class="form-control" id="basicsubjectid" name="args[basicsubjectid]" needle="needle" msg="您必须选择考试题库">
