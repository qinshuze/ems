						...
						<table class="table table-hover table-bordered">
							...
							<tr>
								...
								<td>
									...
									<a role="button" class="btn btn-primary btn-xs ajax" href="index.php?exam-master-basic-clearpoint&sectionid={x2;v:section['sectionid']}" title="更新缓存">更新缓存</a>
									<a role="button" class="btn btn-primary btn-xs ajax" href="index.php?exam-master-basic-output&sectionid={x2;v:section['sectionid']}&page={x2;$page}{x2;$u}" title="导出题库">导出题库</a>
									<a role="button" class="btn btn-primary btn-xs" href="index.php?exam-master-basic-point&sectionid={x2;v:section['sectionid']}&page=1&basicid={x2;v:basic['basicid']}{x2;$u}" title="知识点">知识点</a>
									<a role="button" class="btn btn-primary btn-xs" href="index.php?exam-master-basic-modifysection&sectionid={x2;v:section['sectionid']}&page={x2;$page}{x2;$u}" title="修改章节信息">修改章节信息</a>
									<a role="button" class="btn btn-danger btn-xs confirm" href="index.php?exam-master-basic-delsection&sectionid={x2;v:section['sectionid']}&page={x2;$page}{x2;$u}" title="删除章节">删除章节</a>
