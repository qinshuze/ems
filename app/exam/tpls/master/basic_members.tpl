			        ...
			        <table class="table table-hover table-bordered">
			            ...
			            <tbody>
			            	...
			            	<tr>
								...
								<td>
								  	<div class="btn-group">
			                    		<a class="btn" href="index.php?exam-master-basic-userimage&userid={x2;v:user['userid']}&basicid={x2;v:user['obbasicid']}{x2;$u}" title="能力分析"><em class="glyphicon glyphicon-blackboard"></em></a>
