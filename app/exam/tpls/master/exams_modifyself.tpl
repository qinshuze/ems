			        ...
			        <form action="index.php?exam-master-exams-modify" method="post" class="form-horizontal">
						...
						<div class="form-group questpanel panel_{x2;v:questype['questid']}">
							...
							<div class="col-sm-9 form-inline">
								...
								<span class="info">&nbsp;<a class="btn btn-danger" onclick="javascript:clearnumber('{x2;v:key}')">重置</a></span>
...
function clearnumber(key)
{
	$("#iselectquestions_"+key).val('');
	$("#iselectrowsquestions_"+key).val('');
	$("#ialreadyselectnumber_"+key).html(0);
}
</script>
</body>
</html>
