					        ...
					        <tr>
								...
								<td>
									<div class="btn-group">
			                    		...
			                    		{x2;endif}
										{x2;if:v:exam['examtype'] == 2}
										<a class="btn ajax" href="index.php?{x2;$_app}-master-exams-downloadexam&page={x2;$page}&examid={x2;v:exam['examid']}{x2;$u}" title="下载试卷"><em class="glyphicon glyphicon-download-alt"></em></a>
										<a class="btn" href="index.php?{x2;$_app}-master-exams-score&page={x2;$page}&examid={x2;v:exam['examid']}{x2;$u}" title="设置分数"><em class="glyphicon glyphicon-object-align-horizontal"></em></a>
										{x2;endif}
