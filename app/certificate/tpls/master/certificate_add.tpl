...
{x2;endif}
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;overflow:visible">
					...
					<form action="index.php?certificate-master-certificate-add" method="post" class="form-horizontal">
				        ...
				        <div class="form-group">
				            <label for="contenttitle" class="control-label col-sm-2">关联考场：</label>
				            <div class="col-sm-4">
							    <input class="form-control" name="args[cebasic]" needle="needle" msg="您必须输入需通过的考场ID" placeholder="输入需通过的考场ID">
								<span class="help-block">需要及格的考场ID，多个英文逗号隔开</span>
					        </div>
				        </div>
						<div class="form-group">
							<label for="contenttitle" class="control-label col-sm-2">申请周期：</label>
							<div class="col-sm-4 form-inline">
								<input class="form-control" name="args[cedays]" needle="needle" msg="您必须输入申请周期" placeholder="输入申请周期"> 天
								<span class="help-block">指定天数内不能重复申请</span>
							</div>
						</div>
				        <div class="form-group">
								            ...
								            <ul class="qq-upload-list-selector list-unstyled" aria-live="polite" aria-relevant="additions removals" style="clear:both;">
									            <li class="text-center">
									                <div class="thumbnail">
														...
														<input type="hidden" class="qq-edit-filename-selector" name="args[cethumb]" tabindex="0" value="/files/public/img/noimage.gif">
						                			</div>
									            </li>
									        </ul>
						                </div>
						...
						<div class="form-group">
							<label for="block" class="control-label col-sm-2">证书模板：</label>
							<div class="col-sm-9">
								<script type="text/template" id="pe-template-cetpl">
									<div class="qq-uploader-selector" style="width:30%" qq-drop-area-text="可将图片拖拽至此处上传" style="clear:both;">
										<div class="qq-upload-button-selector" style="clear:both;">
											<ul class="qq-upload-list-selector list-unstyled" aria-live="polite" aria-relevant="additions removals" style="clear:both;">
												<li class="text-center">
													<div class="thumbnail">
														<img class="qq-thumbnail-selector" alt="点击上传新图片">
														<input type="hidden" class="qq-edit-filename-selector" name="args[cetpl]" tabindex="0">
													</div>
												</li>
											</ul>
											<ul class="qq-upload-list-selector list-unstyled" aria-live="polite" aria-relevant="additions removals" style="clear:both;">
												<li class="text-center">
													<div class="thumbnail">
														<img class="qq-thumbnail-selector" src="/files/public/img/noimage.gif" alt="点击上传新图片">
														<input type="hidden" class="qq-edit-filename-selector" name="args[cetpl]" tabindex="0" value="/files/public/img/noimage.gif">
													</div>
												</li>
											</ul>
										</div>
								...
								<div class="fineuploader" attr-type="thumb" attr-template="pe-template-cetpl"></div>
							</div>
						</div>
						<div class="form-group">
							<label for="contenttext" class="control-label col-sm-2">标签位设定</label>
							<div class="col-sm-10">
								<textarea id="cetags" rows="7" cols="4" class="form-control" name="args[cetags]">{x2;$ce['cetags']}</textarea>
							</div>
						</div>
						<div class="form-group">
